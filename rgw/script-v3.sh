...
## column -t | \
## head
## However, this has change for the information print / extraction phase that include 7 columns while the script-v2.sh has 6 columns
...
BEGIN {
    ...
    print "Bucket\tShards_Primary\tObjects_A_Primary\tObjects/Shard_Primary\tObjects_B_Secondary\tShards_Secondary\tDelta_Objects_lagging=Primary-Secondary"
}
...
FNR == NR {
    ...
    fileA_objects[$1] = $3
    num_shards_A = $2 # Get num_shards from fileA
